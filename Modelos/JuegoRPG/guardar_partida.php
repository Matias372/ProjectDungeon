...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    mysqli_stmt_bind_param($stmtPartida, 's', $codigoId);
    ...
    if ($countPartida > 0) {
        ...
        mysqli_stmt_bind_param($stmtUpdatePartida, 'siss', $partida['Nombre'], $partida['Nivel'], $partida['Ubicacion'], $codigoId);
    ...
    mysqli_stmt_bind_param($stmtPersonaje, 's', $codigoId);
